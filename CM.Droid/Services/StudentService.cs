...
namespace CM.Core.Services
{
    public class StudentService: IStudentService
    {
        ...
        public async Task<IStudent> GetByUserName(string userName, string password)
        {
        ...
        public async Task<IStudent> GetById(int studentId)
        {
            var query = from student in new ParseQuery<Student>()
    ...
    public class Student : ParseObject, IStudent
    {
        ...
        int IStudent.GetStudentId()
        {
            return StudentId;
        }

        void IStudent.SetStudentId(int studentId)
        {
